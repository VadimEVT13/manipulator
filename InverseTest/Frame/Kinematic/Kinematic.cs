...
namespace InverseTest
{
    public class Kinematic
    {
        ...
        public bool Inverse(double X, double Y, double Z, double alf, double bet, double gam)
        {
            ...
            if (Math.Sqrt(P3.x * P3.x + P3.y * P3.y + (P3.z - Length.L1) * (P3.z - Length.L1)) <= Length.L2 + Length.L3)
            {
                ...
                /*double[][] R = matrix(m1(Angle.o1 * 180 / Math.PI * Math.PI / 180, Length.L1), m2(Angle.o2 * 180 / Math.PI * Math.PI / 180, Length.L2));
                R = matrix(R, m3(Angle.o3 * 180 / Math.PI * Math.PI / 180, Length.L3));
                R = matrix(R, m4(Angle.o4 * 180 / Math.PI * Math.PI / 180));
                R = matrix(R, m5(Angle.o5 * 180 / Math.PI * Math.PI / 180, Length.L4));
                R = matrix(R, m6(Angle.o6 * 180 / Math.PI * Math.PI / 180));*/
        ...
        public bool InverseNab(double X, double Y, double Z, double X2, double Y2, double Z2)
        {
            ...
            MyPoint nab = new MyPoint(X2, Y2, Z2);
            ...
            if (Math.Sqrt(P3.x * P3.x + P3.y * P3.y + (P3.z - Length.L1) * (P3.z - Length.L1)) <= Length.L2 + Length.L3)
            {
                ...
                //Matrix.m4 = m4(Angle.o4);
                //Matrix.m5 = m5(Angle.o5, Length.R4);
                //Matrix.m6 = m6(Angle.o6);
                /*
                double[][] R = matrix(Matrix.m1, Matrix.m2);
                R = matrix(R, Matrix.m3);
    ...
    static class Length
    {
        public static double L1 = 126;
        public static double L2 = 230;
        public static double L3 = 262;
        public static double L4 = 33;
    }
